...
public class Tactical_Asset_Allocation_of_differnt_rebalance_date4942 extends SimulateStrategy{
	public Tactical_Asset_Allocation_of_differnt_rebalance_date4942(){
		super();
		StrategyID=4942L;
		StrategyClassID=3L;
	}
