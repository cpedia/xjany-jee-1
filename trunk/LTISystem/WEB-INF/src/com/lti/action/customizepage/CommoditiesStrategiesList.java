...
public class CommoditiesStrategiesList extends CustomizePageAction{
	public CommoditiesStrategiesList(){super();}
...
Template t = BasePage.CustomizePageConf.getTemplate("CommoditiesStrategiesList.ftl");ByteArrayOutputStream buf = new ByteArrayOutputStream();Writer out = new OutputStreamWriter(buf, "utf8");		executeUserCode();
		t.process(root, out);		return (buf.toString());
	}
	@SuppressWarnings("unchecked")
	public void executeUserCode() throws Exception {

		  Long SID=14L; //Commodities strategies class ID
