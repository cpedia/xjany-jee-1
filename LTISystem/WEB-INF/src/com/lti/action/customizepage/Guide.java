...
public class Guide extends CustomizePageAction{
	public Guide(){super();}
...
Template t = BasePage.CustomizePageConf.getTemplate("Guide.ftl");ByteArrayOutputStream buf = new ByteArrayOutputStream();Writer out = new OutputStreamWriter(buf, "utf8");		executeUserCode();
