...
public class Bond_Funds_Momentum__Based_on_Upgrading478 extends SimulateStrategy{
	public Bond_Funds_Momentum__Based_on_Upgrading478(){
		super();
		StrategyID=478L;
		StrategyClassID=10L;
	}
...
String[] class1= {"VFISX", "VFITX", "VUSTX", "VWESX", "VBMFX", "VIPSX", "VWEHX", "VFIIX", "VFSTX", "VFICX",  "VBLTX", 
"VFISX", "VFISX", "CASH", "CASH"};
...
double TotalAmount = CurrentPortfolio.getAssetAmount(curAsset,CurrentDate);
CurrentPortfolio.sellAsset(curAsset, CurrentDate);


CurrentPortfolio.buy(curAsset, class1[s], TotalAmount *0.5, CurrentDate);
CurrentPortfolio.buy(curAsset, class1[s-1], TotalAmount * 0.5, CurrentDate);
/*
