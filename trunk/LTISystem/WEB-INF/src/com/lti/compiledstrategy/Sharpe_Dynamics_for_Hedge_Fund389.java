...
public class Sharpe_Dynamics_for_Hedge_Fund389 extends SimulateStrategy{
	public Sharpe_Dynamics_for_Hedge_Fund389(){
		super();
		StrategyID=389L;
		StrategyClassID=15L;
	}
...
,"ASFTX","AASFX","BPTRX","CELSX","CELBX","CELCX","CELIX","CELRX","COAGX"
...
,"SAOCX","SDCQX","TLSAX","TLSBX","CASH", "CASH", "CASH"}; this is from Lipper */
/* from Morningstar long short */
...
printToLog("Top Sharpe List is "+list2);
