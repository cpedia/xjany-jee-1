...
public class Strategic_Asset_Allocation_with_filter_11164921 extends SimulateStrategy{
	public Strategic_Asset_Allocation_with_filter_11164921(){
		super();
		StrategyID=4921L;
		StrategyClassID=3L;
	}
	...
	public void fetchParameters()throws ParameterException{
		...
		RoundtripLimit=(int[])ParameterUtil.fetchParameter("int[]","RoundtripLimit", "60", parameters);
		WaitingPeriod=(int[])ParameterUtil.fetchParameter("int[]","WaitingPeriod", "0", parameters);
	}
	//----------------------------------------------------
	//variables
	//----------------------------------------------------
...
/*
  ...
  public Map<String, Double> AssetPercentageAllocation(List<String> RiskyAssets, List<String> StableAssets, double RiskyAllocation, double[] MainAssetClassWeight, String[] MainAssetClass)  throws Exception {
    ...
    printToLog("Risky Asset Class : " + RiskyAssets);
