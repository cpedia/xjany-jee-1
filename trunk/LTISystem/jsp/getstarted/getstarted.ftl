...
[#if action_name=="f401k__main.action" || action_name?starts_with("getstarted")]
	[#-- for main page --]
	...
	<div id="main">
	  ...
	  <div id="header">
		...
		<div id="blueNavArea">
			<div class="overflow">
				<a id="blueNavTab_1" class="blueNav_item" href="/LTISystem/f401k__ira_brokerage.action">IRA/Brokerage ETF, <br />Mutual Fund Portfolios</a>
			...
			${body}
[#elseif action_name="f401k__mainv2.action"]
	[#-- for main page --]
	<title>${title!"MyPlanIQ 401(k), IRA, Variable Annuity and Taxable Account Investment Solutions"}</title>
	<meta http-equiv="Content-Type" content="text/html; charset=utf-8" />
	<meta http-equiv="Content-Style-Type" content="text/css" />
	    	...
	    	<div class="mast" >
	      	...
	      	<div class="headerSearchArea">
	      		...
	      		<table height='100%' align="right" >
					...
					<td>
								<div class="sld_title" style="margin-top:15px;margin-left:-100px">Smart Strategies for My (Retirement) Investment</div>
...
-->
	...
	<div class="footerColumn">
  		<a href="/LTISystem" class="footerColumnHeading">Site Map</a>
