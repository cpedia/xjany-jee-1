...
public class Optimized_Asset_Allocation_qd1016 extends SimulateStrategy{
	public Optimized_Asset_Allocation_qd1016(){
		super();
		StrategyID=1016L;
		StrategyClassID=3L;
	}
      ...
      // Omit those Funds that 12-month S.D> 1.5*Benchmark
         if(PutThisFund)
         {
             ...
             if (FundSD > BenchSD*1.5)
                 {PutThisFund = false;/*Testing*/printToLog("TYPE 2 ERROR ;  exclude " + CandidateFund[i]);}
         }
