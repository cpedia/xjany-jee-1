...
public class GS_Pure_FundX405 extends SimulateStrategy{
	public GS_Pure_FundX405(){
		super();
		StrategyID=405L;
		StrategyClassID=3L;
	}
	...
	Date startDate;
Date date;
String[] class1= {"VFINX", "VGTSX", "VGSIX", "GLD",  "VUSTX", "VFITX", "VFIIX", "VFICX", "VWEHX", "VIPSX",  "CASH", "CASH","CASH"};
