...
<html>
	<head>
		<title>Group's Portfolio Page</title>
	...
	<s:form action="Save" method="post">
		<table style="BORDER-RIGHT: #a6a398 1px solid; BORDER-TOP: #a6a398 1px solid; BORDER-LEFT: #a6a398 1px solid; BORDER-BOTTOM: #a6a398 1px solid" cellSpacing=0 cellPadding=3 width="95%" align="left">
			...
			<s:textfield name="resourceType" label="ResourceType" value="Portfolio" disabled="true"/>
			<s:textfield name="roleID" label="Role ID"/>
			<s:textfield name="portfolioID" label="Portfolio ID "/>
    ...
    <br>
      <br>
        <br>
          ...
          <p>  &nbsp;</p>
    <p>  role list:</p>      
    <p>  3 role_portfolio_operation   </p>
    <p>  4 role_portfolio_realtime	</p>
    <p>  8 role_portfolio_delayed 	  </p>
	</body>
</html>
