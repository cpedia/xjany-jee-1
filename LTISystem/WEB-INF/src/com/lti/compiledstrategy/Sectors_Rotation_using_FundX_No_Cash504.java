...
public class Sectors_Rotation_using_FundX_No_Cash504 extends SimulateStrategy{
	public Sectors_Rotation_using_FundX_No_Cash504(){
		super();
		StrategyID=504L;
		StrategyClassID=9L;
	}
	...
	Date startDate;
Date date;
String[] class1= {"XLP", "XLV", "XLE", "XLK", "XLI", "XLU", "XLB", "XLY", "XLF"};
