...
public class faqs extends CustomizePageAction{
	public faqs(){super();}
...
Template t = BasePage.CustomizePageConf.getTemplate("faqs.ftl");ByteArrayOutputStream buf = new ByteArrayOutputStream();Writer out = new OutputStreamWriter(buf, "utf8");		executeUserCode();
