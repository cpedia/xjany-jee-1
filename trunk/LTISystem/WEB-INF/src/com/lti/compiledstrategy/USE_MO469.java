...
public class USE_MO469 extends SimulateStrategy{
	public USE_MO469(){
		super();
		StrategyID=469L;
		StrategyClassID=3L;
	...
	Date startDate;
Date date;
String[] class1= {"SPY", "DIA",  "IWM", "IWN", "MDY", "IWC", "QQQQ", "SMH", "BBH", "PPH", "GDX", "XHB", "MOO", "RTH", "XLF", "IBB", "BKH","XLE", "OIH"};
...
CurrentPortfolio.buy("Asset1", getSecurity(class1[s]).getName(), TotalAmount *0.5, CurrentDate);
...
CurrentAsset.setTargetPercentage(0.5);
CurrentPortfolio.addAsset(CurrentAsset);
CurrentPortfolio.buy("Asset2", getSecurity(class1[s-1]).getName(), TotalAmount * 0.5, CurrentDate);
/*
CurrentAsset=new Asset();
CurrentAsset.setAssetStrategyID(getStrategyID("STATIC"));
