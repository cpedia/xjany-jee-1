...
public class Guru_Allocator_RAA487 extends SimulateStrategy{
	public Guru_Allocator_RAA487(){
		super();
		StrategyID=487L;
		StrategyClassID=3L;
	}
...
String[] class1={"HSGFX", "HSTRX", "GGHEX","LCORX", "PASDX","WASYX","VAAPX", "VWINX","GLRBX","FPACX",  "TFSMX", "SWHIX", "DHFCX", "GATEX", "WYASX", "JABAX"}; 
