...
public class Tactical_Asset_Allocation_for_test_10264875 extends SimulateStrategy{
	public Tactical_Asset_Allocation_for_test_10264875(){
		super();
		StrategyID=4875L;
		StrategyClassID=3L;
	}
...
@Override
  public void afterExecuting()   throws Exception {
    ...
    com.lti.util.PersistentUtil.writeGlobalObject(_storeData, "TAA_Data_Plan_" + PlanID,StrategyID,PortfolioID);
