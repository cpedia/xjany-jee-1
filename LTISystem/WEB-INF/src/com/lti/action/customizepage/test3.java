...
public class test3 extends CustomizePageAction{
	public test3(){super();}
...
Template t = BasePage.CustomizePageConf.getTemplate("test3.ftl");ByteArrayOutputStream buf = new ByteArrayOutputStream();Writer out = new OutputStreamWriter(buf, "utf8");		executeUserCode();
		t.process(root, out);		return (buf.toString());
	}
	@SuppressWarnings("unchecked")
	public void executeUserCode() throws Exception {

		root.put("v","vvvvvvvvvvvvvvvvvv");
