...
public class Jegadeesh_s_Stock_Moemntum_Lowest_Rank_Internal552 extends SimulateStrategy{
	public Jegadeesh_s_Stock_Moemntum_Lowest_Rank_Internal552(){
		super();
		StrategyID=552L;
		StrategyClassID=9L;
	}
...
int j=0;
for(int m=sortArray.length-1; j<n;m--)
{
try {CurrentPortfolio.buy("Asset-"+CurPeriod, getSecurity(sortArray[m]).getName(), TotalAmount * ((1.0/HoldingPeriod)/n), CurDate);
