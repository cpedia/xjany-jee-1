...
<html>
	...
	<p class="subtitle">Strategy List</p>
		<table width="100%">
			<tr class="trHeader">
				<td>
					Strategy ID
			...
			<s:iterator value="#request.strategies.items">
				<tr>
					...
					<td>
						<s:url action="Save.action" id="urladdr" namespace="/jsp/admin/group/strategy">
			...
			<tr>
				<td colspan="4">
					...
					<form action='<s:property value="%{url_m}"/>' method="post" onSubmit="this.startIndex.value=(this.startIndex.value-1)*this.pageSize.value;return true;">
						...
						<input type="hidden" name="pageSize" value='<s:property value="#request.strategys.pageSize"/>'/>
