...
public class Tactical_Asset_Allocation_test_reinitial1209 extends SimulateStrategy{
	public Tactical_Asset_Allocation_test_reinitial1209(){
		super();
		StrategyID=1209L;
		StrategyClassID=3L;
	}
	...
	public void fetchParameters()throws ParameterException{
		...
		RoundTrip=(Integer)ParameterUtil.fetchParameter("int","RoundTrip", "12", parameters);
	}
	//----------------------------------------------------
	//variables
	//----------------------------------------------------
...
for(int i = 0; i < SelectedAssets.size(); i++)
{
    ...
    else if(AvailableTradingPercentage > ActualPercentage - TargetPercentage)
    {
        ...
        while(TotalBuyingPercentage > 0.001)
        {
             ...
             //printToLog("Security = " + SecurityName + "  SecurityActualPercentage = " + SecurityActualPercentage + "  SellingPercentage = " + SellingPercentage + "  SecurityTargetPercentage = " + SecurityTargetPercentage  + "  TotalBuyingPercentage = " + TotalBuyingPercentage);
...
///usr/apache-tomcat-6.0.16/webapps/LTISystem/WEB-INF/src/com/lti/compiledstrategy/Tactical_Asset_Allocation_test_reinitial1209.java:254: reinit() in com.lti.type.executor.SimulateStrategy cannot be applied to (com.lti.service.bo.Portfolio,java.util.Hashtable<java.lang.String,java.lang.String>,java.util.Date)
//                 super.reinit(portfolio,parameters,pdate);
//                      ^
///usr/apache-tomcat-6.0.16/webapps/LTISystem/WEB-INF/src/com/lti/compiledstrategy/Tactical_Asset_Allocation_test_reinitial1209.java:252: method does not override or implement a method from a supertype
//@Override
//^
//2 errors