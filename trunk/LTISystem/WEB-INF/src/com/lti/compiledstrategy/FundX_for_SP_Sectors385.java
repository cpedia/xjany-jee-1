...
public class FundX_for_SP_Sectors385 extends SimulateStrategy{
	public FundX_for_SP_Sectors385(){
		super();
		StrategyID=385L;
		StrategyClassID=9L;
	}
	...
	Date startDate;
Date date;
String[] class1= {"XLP", "XLV", "XLE", "XLK", "XLI", "XLU", "XLB", "XLY", "XLF", "CASH", "CASH", "CASH"};
