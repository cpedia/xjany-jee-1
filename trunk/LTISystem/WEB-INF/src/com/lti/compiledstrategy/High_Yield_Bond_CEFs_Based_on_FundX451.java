...
public class High_Yield_Bond_CEFs_Based_on_FundX451 extends SimulateStrategy{
	public High_Yield_Bond_CEFs_Based_on_FundX451(){
		super();
		StrategyID=451L;
		StrategyClassID=10L;
	}
	...
	Date startDate;
Date date;
/*first 5 are  largest high yield bond funds, the list is from WSJ's high yield bond leveraged funds */
/*String[] class1= {"PHK","EAD","HYT","DSU","HIX", "CFD", "COY", "CYE", "HYV","DVF", "HIS","BHY","BLW","ARK","GOF","DHY","DHF","KHI","EOE","FHI","FHY","FT","HAV","HIH",
"HMH","HSA","HYP","HCF","HYF","CIF","MSY","NHS","HYB","PHF","HNW","PHT","VLT"}; */
/*String[] class1= {"PHK","EAD","HYT","DSU","HIX","DVF", "HIS","ARK","GOF","DHY","KHI","EOE","FHI","FHY","FT","HAV","HIH",
"HSA","HCF","CIF","MSY","HYB","PHF","VLT"}; */

String[] class1= {"PHK","EAD","HYT","DSU","HIX"};
...
CurrentPortfolio.buy("Asset5", getSecurity(class1[s-4]).getName(), TotalAmount * 0.2, CurrentDate);*/
	...
	public void action() throws Exception{
		...
		else if (LTIDate.isNYSETradingDay(CurrentDate) && LTIDate.calculateInterval(startDate, CurrentDate)>=30) {
		   startDate=CurrentDate;
