...
<table class="nav" width="100%">
			<td width="20%">
				<s:url action="Main.action" id="url_main" namespace="/jsp/admin/strategyclass" includeParams="none">
				</s:url>
				<s:a href="%{url_main}">Strategy Class Manager</s:a>				
			</td>		
			<td width="20%">
				<s:url action="Save.action" id="url_create" namespace="/jsp/admin/strategyclass" includeParams="none">
					<s:param name="parentID" value="ID"/>
			
					<s:param name="action">create</s:param>
				</s:url>
				<s:a href="%{url_create}">Create A Strategy Class</s:a>				
			</td>
			<td width="60%">
			</td>
</table>
