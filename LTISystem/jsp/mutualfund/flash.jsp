...
String url="/LTISystem/jsp/flash/result/OutputBeta.action?indexArray="+request.getParameter("indexArray")+"&symbol="+request.getParameter("symbol")+"&createTime="+request.getParameter("createTime")+"&IsRAA="+request.getParameter("IsRAA");
