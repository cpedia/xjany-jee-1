...
public class Tactical_Asset_Allocation_short_history_funds_05131114 extends SimulateStrategy{
	public Tactical_Asset_Allocation_short_history_funds_05131114(){
		super();
		StrategyID=1114L;
		StrategyClassID=3L;
	}
...
for(int i=0; i< CandidateFund.length; i++)
{
    ...
    else if( LTIDate.before(getEarliestAvaliablePriceDate(getSecurity(CandidateFund[i])), CurrentDate) && LTIDate.before(getEarliestAvaliablePriceDate(Bench), LTIDate. getNewNYSEMonth(CurrentDate, -12)))
    {
