...
public class CashflowStrategiesList extends CustomizePageAction{
	public CashflowStrategiesList(){super();}
...
Template t = BasePage.CustomizePageConf.getTemplate("CashflowStrategiesList.ftl");ByteArrayOutputStream buf = new ByteArrayOutputStream();Writer out = new OutputStreamWriter(buf, "utf8");		executeUserCode();
		t.process(root, out);		return (buf.toString());
	}
	@SuppressWarnings("unchecked")
	public void executeUserCode() throws Exception {

		  Long SID=5L; //Cashflow strategies class ID
