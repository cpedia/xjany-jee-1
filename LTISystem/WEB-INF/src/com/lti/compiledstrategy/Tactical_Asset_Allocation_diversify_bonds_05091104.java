...
public class Tactical_Asset_Allocation_diversify_bonds_05091104 extends SimulateStrategy{
	public Tactical_Asset_Allocation_diversify_bonds_05091104(){
		super();
		StrategyID=1104L;
		StrategyClassID=3L;
	}
...
for(int j = 0; j < RepresentNumber; j++)
{
    ...
    { 
        ...
        if(SelectedAssets.get(i).equals("CASH") && RepresentFundList.indexOf("CASH") < 0)      
        {
...
for(int j = 0; j < RepresentNumber; j++)
{
    ...
    { 
        ...
        if(SelectedAssets.get(i).equals("CASH") && RepresentFundList.size() == 0)      
        {
            RepresentFundList.add("CASH");
        }
        if(!SelectedAssets.get(i).equals("CASH"))
