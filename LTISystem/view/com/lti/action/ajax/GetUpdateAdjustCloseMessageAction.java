...
public class GetUpdateAdjustCloseMessageAction extends ActionSupport implements Action {
	...
	public String execute() throws Exception {
		...
		try {
			resultString = UpdateAdjustCloseAction.getMessage( ActionContext.getContext().getSession());
