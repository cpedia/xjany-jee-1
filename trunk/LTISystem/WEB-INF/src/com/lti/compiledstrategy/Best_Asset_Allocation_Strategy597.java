...
public class Best_Asset_Allocation_Strategy597 extends SimulateStrategy{
	public Best_Asset_Allocation_Strategy597(){
		super();
		StrategyID=597L;
		StrategyClassID=3L;
	}
	...
	public void fetchParameters()throws ParameterException{
		...
		class1=(String[])ParameterUtil.fetchParameter("String[]","class1", "P_5350, P_3844, P_5376, P_3318, P_5198, P_3212, P_3990, P_5671, P_3202,P_4602", parameters);
	}
	//----------------------------------------------------
	//variables
	//----------------------------------------------------
	Date startDate;
Date date;
/*String[] class1= {"P_5350", "P_3844", "P_5376", "P_3318", "P_5198", "P_3212", "P_3990", "P_5671", "P_3202","P_4602"};*/
...
CurrentPortfolio.buy("Asset1", getSecurity(class1[s]).getName(), TotalAmount , CurrentDate);
/*
CurrentAsset=new Asset();
CurrentAsset.setAssetStrategyID(getStrategyID("STATIC"));
...
*/
	...
	public void action() throws Exception{
		...
		else if (((Frequency==0)&& LTIDate.isNYSETradingDay(CurrentDate) && LTIDate.calculateInterval(startDate, CurrentDate)>=30) || ((Frequency==1)&& LTIDate.isNYSETradingDay(CurrentDate) && LTIDate.calculateInterval(startDate, CurrentDate)>=90) || ((Frequency==2)&& LTIDate.isNYSETradingDay(CurrentDate) && LTIDate.calculateInterval(startDate, CurrentDate)>=180)) {
		   startDate=CurrentDate;
