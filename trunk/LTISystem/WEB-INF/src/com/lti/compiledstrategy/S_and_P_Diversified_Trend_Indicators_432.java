...
public class S_and_P_Diversified_Trend_Indicators_432 extends SimulateStrategy{
	public S_and_P_Diversified_Trend_Indicators_432(){
		super();
		StrategyID=432L;
		StrategyClassID=3L;
	}
...
String[] securitynameArray={"DBE","DBB","DBP","DBA","FXE","FXY","FXB","FXF","FXC","FXA","IEF",
"SHY"};

double[] percentageofall={0.1875,0.05,0.0525,0.21,0.13,0.12,0.05,0.02,0.02,0.01,0.075,0.075};
