...
public class GS_PURE_FundX_with_Emerging_Mkt446 extends SimulateStrategy{
	public GS_PURE_FundX_with_Emerging_Mkt446(){
		super();
		StrategyID=446L;
		StrategyClassID=3L;
	}
	...
	Date startDate;
Date date;
String[] class1= {"VFINX", "VGTSX", "VEIEX", "VGSIX", "QRAAX", "VUSTX", "CASH", "CASH","CASH"};
