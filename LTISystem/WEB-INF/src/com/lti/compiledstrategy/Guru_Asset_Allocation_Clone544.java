...
public class Guru_Asset_Allocation_Clone544 extends SimulateStrategy{
	public Guru_Asset_Allocation_Clone544(){
		super();
		StrategyID=544L;
		StrategyClassID=3L;
	}
...
String[] class1={"HSGFX", "HSTRX", "GGHEX","GBMFX", "LCORX", "PASDX","WASYX","VAAPX", "VWINX","GLRBX","FPACX",  "TFSMX",  "DHFCX", "GATEX", "WYASX", "JABAX"}; 
