...
public class Primer extends CustomizePageAction{
	public Primer(){super();}
...
Template t = BasePage.CustomizePageConf.getTemplate("Primer.ftl");ByteArrayOutputStream buf = new ByteArrayOutputStream();Writer out = new OutputStreamWriter(buf, "utf8");		executeUserCode();
