...
<html>
	...
	<div>
	    <s:form namespace="/jsp/admin/strategy">
		<s:textfield name="planID" theme="simple"></s:textfield>
	...
	<s:a href="%{url_create}">Create</s:a>
		...
		Change to
			...
			<s:iterator value="#request.strategies.parameters10" id="parameter" status="st">
				<s:url action="SimilarIssues" id="pageurl">
			...
			<s:url action="SimilarIssues" id="url_last">
		...
		<s:url action="SimilarIssues" id="url_m" includeParams="none">
		<s:param name="planID" value="planID"></s:param>
		</s:url>								
		Page
