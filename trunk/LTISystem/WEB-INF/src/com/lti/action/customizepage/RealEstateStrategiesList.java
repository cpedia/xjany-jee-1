...
public class RealEstateStrategiesList extends CustomizePageAction{
	public RealEstateStrategiesList(){super();}
...
Template t = BasePage.CustomizePageConf.getTemplate("RealEstateStrategiesList.ftl");ByteArrayOutputStream buf = new ByteArrayOutputStream();Writer out = new OutputStreamWriter(buf, "utf8");		executeUserCode();
		t.process(root, out);		return (buf.toString());
	}
	@SuppressWarnings("unchecked")
	public void executeUserCode() throws Exception {

		  Long SID=13L; //Real Estate strategies class ID
