...
(function($) {
	...
	function createElement(text) {
		...
		var content = " <div style='width:" +width+ "px; height:" +Height+ "px;'><div style='width:100%; height:30px; line-height:31px;padding-left:15px;font-weight:bolder; color:#000000;font-size:15px;'>"+text+"</div><div align='center'><img src='/LTISystem/jsp/template/ed/images/loading.gif' border='0'/></div></div>";
