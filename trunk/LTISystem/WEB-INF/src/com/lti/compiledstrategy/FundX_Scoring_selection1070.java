...
public class FundX_Scoring_selection1070 extends SimulateStrategy{
	public FundX_Scoring_selection1070(){
		super();
		StrategyID=1070L;
		StrategyClassID=9L;
	}
	...
	public void fetchParameters()throws ParameterException{
		...
		class1=(String[])ParameterUtil.fetchParameter("String[]","class1", "FSAIX, FSAVX, FSRBX,  FBIOX,FSLBX,FSCHX,FSDCX,FDCPX,FSHOX,FSCPX,FDFAX,FSDAX,FSELX,FSENX,FSESX,FSLEX,FIDSX,FSAGX,FSPHX,FSVLX,FSCGX,FCYIX,FSPCX,FBSOX,FDLSX,FSDPX,FSHCX,FSMEX,FBMPX,FSNGX,FNARX,FNINX,FSPFX,FPHAX,FSRPX,FSCSX,FSPTX,FSTCX,FSRFX,FSUTX,FWRLX,FSRRX,FIUIX", parameters);
	}
	//----------------------------------------------------
	//variables
	//----------------------------------------------------
