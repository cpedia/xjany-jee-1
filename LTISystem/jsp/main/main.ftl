...
-->
            ...
            <div id="vf_main" style="border: none; width:63%; min-height:350px">
             <p align="center" style="padding:0px; margin:0px;"><img width="350px" height="75px" src="/LTISystem/UserFiles/Image/AsSimpleAs.jpg" border=none></p>
            <p align="left" style="padding:0px; margin:0px;"><a title="Find Strategy"  href="/LTISystem/jsp/strategy/Main.action?group=public"><img width="630px" height="75px" src="/LTISystem/UserFiles/Image/StrategyButton.jpg" border=none></a></p>
            <p align="left" style="padding:0px; margin:0px;"><a title="Customize Portfolio"  href="/LTISystem/jsp/portfolio/ViewPortfolio.action?ID=4406"><img width="630px" height="75px" src="/LTISystem/UserFiles/Image/PortfolioButton.jpg" border=none></a></p>
            <p align="left" style="padding:0px; margin:0px;"><a title="Email Alert"  href="/LTISystem/jsp/portfolio/Edit.action?ID=4407"><img width="630px" height="75px" src="/LTISystem/UserFiles/Image/EmailAlertButton.jpg" border=none></a></p>
            </div>
            <div id="vf_rightbar" style="border: none; width:34%; min-height:350px">
             <p align="center" style="padding-top:10px; margin-top:10px;"><a title="MyPlanIQ" href="http://www.myplaniq.com"><img  style="padding-top:0px; margin-top:0px;" width="290px" height="290px" src="/LTISystem/UserFiles/Image/mpiq_vf.jpg" border=none></a></p>
             <p align="center"><h3 align="center"><a href="http://www.myplaniq.com">www.MyPlanIQ.com</a></h3></p>
            </div> 
