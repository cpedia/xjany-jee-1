...
public class Best_of_Global_Tactical_Asset_Allocation_Value_and_Momentum_527 extends SimulateStrategy{
	public Best_of_Global_Tactical_Asset_Allocation_Value_and_Momentum_527(){
		super();
		StrategyID=527L;
		StrategyClassID=3L;
	}
...
*/
	...
	public void action() throws Exception{
		...
		else if (((Frequency==0)&& LTIDate.isNYSETradingDay(CurrentDate) && LTIDate.calculateInterval(startDate, CurrentDate)>=30) || ((Frequency==1)&& LTIDate.isNYSETradingDay(CurrentDate) && LTIDate.calculateInterval(startDate, CurrentDate)>=90) ) {
		   startDate=CurrentDate;
