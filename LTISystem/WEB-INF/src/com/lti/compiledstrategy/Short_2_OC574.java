...
public class Short_2_OC574 extends SimulateStrategy{
	public Short_2_OC574(){
		super();
		StrategyID=574L;
		StrategyClassID=2L;
	}
	...
	public void fetchParameters()throws ParameterException{
		...
		OpenClose=(Boolean)ParameterUtil.fetchParameter("boolean","OpenClose", "true", parameters);
	}
	//----------------------------------------------------
	//variables
	//----------------------------------------------------
...
TotalAmount = CurrentPortfolio.getTotalAmount(CurrentDate);
   ...
   /* buy at close, sell at next day open */
   /* sell first */
