...
public class Goldman_Sachs_Global_Tactical_With_Fundx_Style_372 extends SimulateStrategy{
	public Goldman_Sachs_Global_Tactical_With_Fundx_Style_372(){
		super();
		StrategyID=372L;
		StrategyClassID=3L;
	}
	...
	Date startDate;
Date date;
String[] class1= {"VFINX", "VGTSX", "VGSIX", "QRAAX", "VUSTX", "CASH", "CASH","CASH"};
int NumberOfDays;
