...
public class Treasury_long_bond_Momentum486 extends SimulateStrategy{
	public Treasury_long_bond_Momentum486(){
		super();
		StrategyID=486L;
		StrategyClassID=10L;
	}
...
String[] class1= {"VUSTX", "CASH"};
//String[] underlying={"JNK", "LQD", "TIP", "BKT", "TLT", "SHY", "BWX", "CASH"};
...
CurrentPortfolio.buy("Asset1", class1[s], TotalAmount *1.0, CurrentDate);
