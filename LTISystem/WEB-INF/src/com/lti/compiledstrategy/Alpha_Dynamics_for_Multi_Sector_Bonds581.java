...
public class Alpha_Dynamics_for_Multi_Sector_Bonds581 extends SimulateStrategy{
	public Alpha_Dynamics_for_Multi_Sector_Bonds581(){
		super();
		StrategyID=581L;
		StrategyClassID=10L;
	}
	...
	public void fetchParameters()throws ParameterException{
		...
		Funds=(String[])ParameterUtil.fetchParameter("String[]","Funds", "OSTIX, INCMX, OSIYX, STICX, IOSIX, RPSIX,FSICX, IOSSX, FKSAX, FSRIX, LSIZX, KSTSX, LSBDX, VCSBX, NEZYX, JESNX, MFIIX, PDVYX,  HLIZX, HSNIX, JHSBX, JHSTX, JISBX, LBDFX, LBSTX, LCMAX, RSFRX, RSTRX, SEEAX, SMARX, STIZX, YQFIX, CASH, CASH, CASH", parameters);
	}
	//----------------------------------------------------
	//variables
	//----------------------------------------------------
...
|| (AdjustFrequency.equals("month") && LTIDate.isLastNYSETradingDayOfMonth(CurrentDate))) {
		   //List <Security > list1=getSecurityByClass(2);
//Define a list of fixed income securities. 
//printToLog(list1);
