...
public class HomePage extends CustomizePageAction{
...
Template t = BasePage.CustomizePageConf.getTemplate("HomePage.ftl");ByteArrayOutputStream buf = new ByteArrayOutputStream();Writer out = new OutputStreamWriter(buf, "utf8");		executeUserCode();
