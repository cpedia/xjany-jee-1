...
public class GS_PURE_FundX_For_Hedge443 extends SimulateStrategy{
	public GS_PURE_FundX_For_Hedge443(){
		super();
		StrategyID=443L;
		StrategyClassID=3L;
	}
	...
	Date startDate;
Date date;
String[] class1= {"AASFX", "ALHIX",  "ALPHX", "ANGLX", "ARBNX", "BETAX", "BMNIX", "DDMSX", "DVRIX", "DVRKX", 
