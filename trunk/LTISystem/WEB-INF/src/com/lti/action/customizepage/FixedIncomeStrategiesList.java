...
public class FixedIncomeStrategiesList extends CustomizePageAction{
	public FixedIncomeStrategiesList(){super();}
...
Template t = BasePage.CustomizePageConf.getTemplate("FixedIncomeStrategiesList.ftl");ByteArrayOutputStream buf = new ByteArrayOutputStream();Writer out = new OutputStreamWriter(buf, "utf8");		executeUserCode();
		t.process(root, out);		return (buf.toString());
	}
	@SuppressWarnings("unchecked")
	public void executeUserCode() throws Exception {

		  Long SID=10L; //Fixed income strategies class ID
