...
public class Dow_30_Stock_Momentum_Based_on_FundX_Scoring533 extends SimulateStrategy{
	public Dow_30_Stock_Momentum_Based_on_FundX_Scoring533(){
		super();
		StrategyID=533L;
		StrategyClassID=9L;
	}
...
String[] class1= {"AA", "AXP", "BA", "BAC", "C", "CAT", "CVX", "DD", "DIS", "GE", "GM", "HD", "HPQ", "IBM", "INTC", "JNJ", "JPM", "KFT", "KO", "MCD", "MMM", "MRK", "MSFT", "PFE", "PG", "T", "UTX", "VZ", "WMT", "XOM"};
