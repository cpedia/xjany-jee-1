...
public class Tactical_Asset_Allocation_for_529_new_engine4848 extends SimulateStrategy{
	public Tactical_Asset_Allocation_for_529_new_engine4848(){
		super();
		StrategyID=4848L;
		StrategyClassID=3L;
	}
...
public void initmpts(Map<String, CandidateFundType> CandidateFundMap)  throws Exception {
  ...
  public void initStoreData(String dateStr, Map<String, CandidateFundType> CandidateFundMap) throws Exception {
    ...
    if(_storeData==null || _rewriteData || PlanID == 0){
