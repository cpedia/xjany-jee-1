...
public class StrategyClass3 extends CustomizePageAction{
	public StrategyClass3(){super();}
...
Template t = BasePage.CustomizePageConf.getTemplate("StrategyClass3.ftl");ByteArrayOutputStream buf = new ByteArrayOutputStream();Writer out = new OutputStreamWriter(buf, "utf8");		executeUserCode();
