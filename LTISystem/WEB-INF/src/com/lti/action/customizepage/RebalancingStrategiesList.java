...
public class RebalancingStrategiesList extends CustomizePageAction{
	public RebalancingStrategiesList(){super();}
...
Template t = BasePage.CustomizePageConf.getTemplate("RebalancingStrategiesList.ftl");ByteArrayOutputStream buf = new ByteArrayOutputStream();Writer out = new OutputStreamWriter(buf, "utf8");		executeUserCode();
		t.process(root, out);		return (buf.toString());
	}
	@SuppressWarnings("unchecked")
	public void executeUserCode() throws Exception {

		  Long SID=4L; //Rebalancing strategies class ID
