...
public class RSI_5_Day_Buy_and_Sell_Signal_Strategy142 extends SimulateStrategy{
	public RSI_5_Day_Buy_and_Sell_Signal_Strategy142(){
		super();
		StrategyID=142L;
		StrategyClassID=9L;
	}
	...
	public void fetchParameters()throws ParameterException{
		...
		userSecurity=(String)ParameterUtil.fetchParameter("String","userSecurity", "^IRX", parameters);
	}
	//----------------------------------------------------
	//variables
	//----------------------------------------------------
...
confidenceCheckStart("RSI Buy",amount,CurrentDate);
printToLog("Buy is triggeed!");
...
position=true;
		   ...
		   double amount=CurrentPortfolio.getAssetAmount(curAsset, CurrentDate);
confidenceCheckEnd("RSI Buy",amount,CurrentDate);
printToLog("Sell is triggeed!");
CurrentPortfolio.sellAsset(curAsset,CurrentDate);
