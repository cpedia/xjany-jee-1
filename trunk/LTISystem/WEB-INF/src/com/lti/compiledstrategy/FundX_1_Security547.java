...
public class FundX_1_Security547 extends SimulateStrategy{
	public FundX_1_Security547(){
		super();
		StrategyID=547L;
		StrategyClassID=2L;
	}
	...
	public void fetchParameters()throws ParameterException{
		...
		Securities=(String[])ParameterUtil.fetchParameter("String[]","Securities", "P_4066, CASH", parameters);
	}
	//----------------------------------------------------
	//variables
	//----------------------------------------------------
