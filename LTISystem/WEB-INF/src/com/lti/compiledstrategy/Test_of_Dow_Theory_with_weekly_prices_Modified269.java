...
public class Test_of_Dow_Theory_with_weekly_prices_Modified269 extends SimulateStrategy{
	public Test_of_Dow_Theory_with_weekly_prices_Modified269(){
		super();
		StrategyID=269L;
		StrategyClassID=0L;
	}
...
//Date [][]PullbackTime=new Date[2][10];
int DJIMaxCount;
int DJTMaxCount;
int DJIMinCount;
int DJTMinCount;
...
CurrentPortfolio.buy (curAsset, "^DJI", amount, CurrentDate);
