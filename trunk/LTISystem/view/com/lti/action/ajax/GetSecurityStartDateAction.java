...
public class GetSecurityStartDateAction extends ActionSupport implements Action {
	...
	public String execute(){
		...
		try {
			if(symbol!=null){
				String startDate;
				startDate = df.format(securityManager.get(symbol).getStartDate());
				resultString = startDate;
			}
			else
