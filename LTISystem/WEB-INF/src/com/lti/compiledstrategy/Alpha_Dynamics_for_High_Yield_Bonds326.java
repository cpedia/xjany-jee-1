...
public class Alpha_Dynamics_for_High_Yield_Bonds326 extends SimulateStrategy{
	public Alpha_Dynamics_for_High_Yield_Bonds326(){
		super();
		StrategyID=326L;
		StrategyClassID=10L;
	}
