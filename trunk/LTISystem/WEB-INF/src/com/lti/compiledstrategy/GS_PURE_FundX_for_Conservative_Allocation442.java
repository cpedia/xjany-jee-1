...
public class GS_PURE_FundX_for_Conservative_Allocation442 extends SimulateStrategy{
	public GS_PURE_FundX_for_Conservative_Allocation442(){
		super();
		StrategyID=442L;
		StrategyClassID=3L;
	}
	...
	Date startDate;
Date date;
String[] class1= {"HSTRX", "PRPFX", "BERIX", "EXDAX", "GECAX", "GCSTX", "AONIX", "AOCIX", "MACIX", "VWIAX", "MACJX", "VWINX", "TWSCX", "COTZX", "VSCGX", "HBFBX", "PRSIX", "VASIX", "SCCTX", "DGTSX", "DGIIX", "MLLIX", "NIPAX", "FRIAX", "VTMFX", "MLLJX", "THYFX", "VPCGX", "FSRRX", "FSIRX", "FSFYX", "GSBSX", "ILOSX", "PRTEX", "VPSOX", "JELMX", "RMLSX", "FASIX", "JELCX", "ABPYX", "AGIYX", "SMOAX", "OYCIX", "RMLEX", "SWCGX", "ISFYX", "LIMVX", "DIIHX", "BRBPX", "DVMSX", "USBLX", "DIHSX", "ACIYX", "SOKAX", "GFIYX", "SVRIX", "SVSAX", "DVSIX", "GFIZX", "IMSIX", "RCLSX", "AIGAX", "RCLEX", "SCRIX", "GFIVX", "PACYX", "SWARX", "LCVIX", "NCBIX", "SVVIX", "SSLIX", "SNSAX", "MXIIX","CASH", "CASH","CASH"};
