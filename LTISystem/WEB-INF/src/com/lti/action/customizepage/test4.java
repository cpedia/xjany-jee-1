...
public class test4 extends CustomizePageAction{
	public test4(){super();}
...
Template t = BasePage.CustomizePageConf.getTemplate("test4.ftl");ByteArrayOutputStream buf = new ByteArrayOutputStream();Writer out = new OutputStreamWriter(buf, "utf8");		executeUserCode();
