...
<table width="100%" height="100%" border="0" cellpadding="0" cellspacing="0" class="borderBlue">
  ...
  <tr>
    ...
    <table width="98%" border="0" cellpadding="3" cellspacing="1" bgcolor="#CCCCCC" class="font12">
		<tr class="
Error on line 102, column 22 in labStatusList.jsp
Expecting a string, date or number here, Expression table?keys is instead a freemarker.core.CollectionAndSequence
The problematic instruction:
----------
==> ${table?keys} [on line 102, column 20 in labStatusList.jsp]
----------

Java backtrace for programmers:
----------
freemarker.core.NonStringException: Error on line 102, column 22 in labStatusList.jsp
Expecting a string, date or number here, Expression table?keys is instead a freemarker.core.CollectionAndSequence
	...
	at com.xjany.common.util.GrenricUtil._get_code(GrenricUtil.java:33)
	at com.xjany.bbs.action.admin.TempleteAction.main(TempleteAction.java:41)
