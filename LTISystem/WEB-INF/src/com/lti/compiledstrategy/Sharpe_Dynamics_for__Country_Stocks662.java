...
public class Sharpe_Dynamics_for__Country_Stocks662 extends SimulateStrategy{
	public Sharpe_Dynamics_for__Country_Stocks662(){
		super();
		StrategyID=662L;
		StrategyClassID=12L;
	}
...
String[] conservatives= {"EWN", "EWG", "EWQ", "EWL", "EWI", "EWU", "EWK", "EWA", "EWC", "EWS", "EWJ", "EZA", "EWH", "EWZ", "FXI", "EWY", "RSX", "CASH", "CASH", "CASH"};
...
printToLog(alphafund[i].getName()); }
