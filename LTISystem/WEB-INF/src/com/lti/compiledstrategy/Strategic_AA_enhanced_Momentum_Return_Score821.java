...
public class Strategic_AA_enhanced_Momentum_Return_Score821 extends SimulateStrategy{
	public Strategic_AA_enhanced_Momentum_Return_Score821(){
		super();
		StrategyID=821L;
		StrategyClassID=3L;
	}
	...
	public void fetchParameters()throws ParameterException{
		...
		SortMethod=(String)ParameterUtil.fetchParameter("String","SortMethod", "RETURN", parameters);
	}
	//----------------------------------------------------
	//variables
	//----------------------------------------------------
