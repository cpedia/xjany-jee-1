...
public class Copy2_of_Tactical_Asset_Allocation_401k1072 extends SimulateStrategy{
	public Copy2_of_Tactical_Asset_Allocation_401k1072(){
		super();
		StrategyID=1072L;
		StrategyClassID=3L;
	}
    ...
    else if(AvailableTradingPercentage > ActualPercentage - TargetPercentage)
    {
        ...
        while(TotalBuyingPercentage > 0.001)
        {
             ...
             if(SecurityActualPercentage - SellingPercentage >= MaxOfSecurityPercentage)
             {
                 ...
                 if(j == PresentativeSecurityList.size() -1)
        ...
        if(TradePercentage < 0)
           {
               ...
               printToLog("sell  =" +  TradingSecurity  +  "Percentage trading" +  TradePercentage );
            }
        }
    }
}
        ...
        if(TradePercentage.doubleValue() > 0)
            {
                CurrentPortfolio.buyAtNextOpen(AssetName, TradingSecurity, TotalAmount * TradePercentage.doubleValue(), CurrentDate,true);
                  printToLog("buy  =" +  TradingSecurity  +  "Percentage trading" +  TradePercentage );
            }
        }
    }
}
