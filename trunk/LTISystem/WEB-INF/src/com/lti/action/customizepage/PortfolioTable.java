...
public class PortfolioTable extends CustomizePageAction{
	public PortfolioTable(){super();}
...
Template t = BasePage.CustomizePageConf.getTemplate("PortfolioTable.ftl");ByteArrayOutputStream buf = new ByteArrayOutputStream();Writer out = new OutputStreamWriter(buf, "utf8");		executeUserCode();
		t.process(root, out);		return (buf.toString());
	}
	@SuppressWarnings("unchecked")
	public void executeUserCode() throws Exception {

		Long[] ids1={3628L,3630L,3632L};
Long[] ids2={3628L,3630L,3632L};
Long[] ids3={3628L,3630L,3632L};
