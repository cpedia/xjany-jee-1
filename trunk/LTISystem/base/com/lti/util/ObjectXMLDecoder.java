...
public class ObjectXMLDecoder {
	...
	public static Object XMLToObject(Element root) {
		...
		if (type.equalsIgnoreCase("java.lang.String") || type.equals("String")) {
		...
		} else if (type.equalsIgnoreCase("java.util.Hashtable")||type.equalsIgnoreCase("java.util.HashMap")) {

			List<Node> pairList = getChildsByTag(root, "pair");
			if (pairList == null)
				return null;
			Map<String, String> ht = null;
			if(type.equalsIgnoreCase("java.util.Hashtable")){
			...
			obj = ht;
		} else if (type.equalsIgnoreCase("java.util.Set") || type.equalsIgnoreCase("java.util.List")|| type.equalsIgnoreCase("java.util.ArrayList")) {
			Collection col = null;
