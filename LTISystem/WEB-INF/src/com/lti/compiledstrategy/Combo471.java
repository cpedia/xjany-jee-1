...
public class Combo471 extends SimulateStrategy{
	public Combo471(){
		super();
		StrategyID=471L;
		StrategyClassID=3L;
	...
	public void fetchParameters()throws ParameterException{
		...
		funds=(String[])ParameterUtil.fetchParameter("String[]","funds", "P_3338, EFA,  P_3340,  IYR, TLT, CASH, CASH, CASH", parameters);
	}
	//----------------------------------------------------
	//variables
	//----------------------------------------------------
	Date startDate;
Date date;
//String[] class1= {"P_3338", "EFA",  "P_3340",  "IYR", "TLT", "CASH", "CASH", "CASH"};
String[] class1;
...
CurrentPortfolio.buy("Asset1", class1[s], TotalAmount *0.34, CurrentDate);
...
CurrentPortfolio.addAsset(CurrentAsset);
CurrentPortfolio.buy("Asset2", class1[s-1], TotalAmount * 0.33, CurrentDate);
