...
public class O_Neil_s_CAN_SLIM_System_Strategy_MemoryImpl_607 extends SimulateStrategy{
	public O_Neil_s_CAN_SLIM_System_Strategy_MemoryImpl_607(){
		super();
		StrategyID=607L;
		StrategyClassID=3L;
	}
	...
	//----------------------------------------------------
	List<String>stocks;
//String[] stocks={"GFRE","HSR","TLVT","BIDU","CTRP","CTSH","INFY","VPRT","AAPL","CERN","ARO","FTI","INFA","CHSI","SQM","CHRW","PETS"};
//String[] stocks={"FUQI"};
...
//check whether the floats is less than 20 million
Double floats=financialStatement.getFloats(symbol,year1Q,quarter1Q);
if(floats!=null&&floats<20000000)floatFlg=true;
//printToLog(symbol+"'s check whether the floats is less than 20 million:"+floatFlg);
if(!floatFlg)continue;
floatCount++;


if(EPSGrowth1Flg&&EPSGrowth2Flg&&EPSFlg&&EPSGrowth3Flg&&EPSGrowth4Flg&&priceFlg&&floatFlg&&RSFlg&&HolderFlg)selected.add(stocks.get(i));
}
