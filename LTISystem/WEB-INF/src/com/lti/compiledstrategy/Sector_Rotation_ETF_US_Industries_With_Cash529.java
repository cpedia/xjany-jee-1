...
public class Sector_Rotation_ETF_US_Industries_With_Cash529 extends SimulateStrategy{
	public Sector_Rotation_ETF_US_Industries_With_Cash529(){
		super();
		StrategyID=529L;
		StrategyClassID=9L;
	}
	...
	Date startDate;
Date date;
/* all Fidelity Select Funds representing stock industries */
String[] class1= {"XLF", "PJB", "KIE", "IAI", "IYG", "IYR", "IBB", "PPH", "XLV", "XLY", "XLP", "XLI", "IYT", "XHB", "MOO",  "PPA", "RTH", "TAN", "XLE", "OIH", "XLB", "KOL", "NLR", "SLX", "GEX", "PHO", "XME", "GDX", "QQQQ", "SMH", "XLU", "IYZ", "CASH", "CASH", "CASH"};
