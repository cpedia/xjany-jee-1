...
public class AllStrategiesTable extends CustomizePageAction{
	public AllStrategiesTable(){super();}
...
Template t = BasePage.CustomizePageConf.getTemplate("AllStrategiesTable.ftl");ByteArrayOutputStream buf = new ByteArrayOutputStream();Writer out = new OutputStreamWriter(buf, "utf8");		executeUserCode();
