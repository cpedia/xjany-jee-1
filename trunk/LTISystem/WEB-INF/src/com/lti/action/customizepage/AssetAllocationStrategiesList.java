...
public class AssetAllocationStrategiesList extends CustomizePageAction{
	public AssetAllocationStrategiesList(){super();}
...
Template t = BasePage.CustomizePageConf.getTemplate("AssetAllocationStrategiesList.ftl");ByteArrayOutputStream buf = new ByteArrayOutputStream();Writer out = new OutputStreamWriter(buf, "utf8");		executeUserCode();
		t.process(root, out);		return (buf.toString());
	}
	@SuppressWarnings("unchecked")
	public void executeUserCode() throws Exception {

		  Long SID=3L; //asset allocation strategy class ID
  ...
  StrategyClass sc = strategyClassManager.get(SID);
