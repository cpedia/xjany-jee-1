...
public class HedgeStrategiesList extends CustomizePageAction{
	public HedgeStrategiesList(){super();}
...
Template t = BasePage.CustomizePageConf.getTemplate("HedgeStrategiesList.ftl");ByteArrayOutputStream buf = new ByteArrayOutputStream();Writer out = new OutputStreamWriter(buf, "utf8");		executeUserCode();
		t.process(root, out);		return (buf.toString());
	}
	@SuppressWarnings("unchecked")
	public void executeUserCode() throws Exception {

		  Long SID=15L; //Hedge strategies class ID
