...
public class GS_FundX_Values550 extends SimulateStrategy{
	public GS_FundX_Values550(){
		super();
		StrategyID=550L;
		StrategyClassID=3L;
	}
	...
	public void fetchParameters()throws ParameterException{
		...
		Yearly=(Boolean)ParameterUtil.fetchParameter("boolean","Yearly", "true", parameters);
	}
	//----------------------------------------------------
	//variables
	//----------------------------------------------------
	Date startDate;
Date date;
String[] class1= {"VISVX", "VTRIX", "TAREX", "GLD", "LSBDX", "VWEHX", "VFSTX", "VFICX", "VWESX", "VFIIX", "VUSTX", "VIPSX", "VFITX", "VSGBX", "CASH", "CASH","CASH"};
...
a =(getSecurity(class1[i]).getReturn(CurrentDate, TimeUnit.MONTHLY, -6)
+ getSecurity(class1[i]).getReturn(CurrentDate, TimeUnit.MONTHLY, -3)
+ getSecurity(class1[i]).getReturn(CurrentDate, TimeUnit.MONTHLY, -1 ))*100/3;
}
