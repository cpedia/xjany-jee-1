...
public class Strategic_Asset_Allocation_deal_with_no_price_benchmark_06101156 extends SimulateStrategy{
	public Strategic_Asset_Allocation_deal_with_no_price_benchmark_06101156(){
		super();
		StrategyID=1156L;
		StrategyClassID=3L;
	}
...
catch(Exception e){printToLog("---------------------Action error---------------------------------------");}
		}
